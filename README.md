...
A visual quality-control system that spots defects in product images, trained and tested on the MVTec AD benchmark (bottle category). It learns what a normal, defect-free product looks like, then flags anything that doesn't match. No labeled defect images needed for training. (Self-Supervised Learning)

**Live Demo:** https://inspectx.streamlit.app/

**Sample Test Images:** [Download a few test images](https://github.com/aathif-gh/Inspectx-defect-detection/releases/download/v1.0-samples/sample_images.zip) (mix of good, bad, small broken, large broken and contaminated test images of bottles) to try on the live demo.
